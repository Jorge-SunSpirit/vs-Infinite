...
class InfCreditsState extends MusicBeatState
{
	...
	var userChara:Array<Array<String>> = [ //Name - Icon name - role - Quote of the day - Link - Which Row - position
		...
		['SirDusterBuster',	'duster',	'Sprite Animator',	"hueh",	'https://twitter.com/SirDusterBuster',	"0", "2"],
		...
		['HighPoweredKeyz',	'hpk',	'Chromatic Assistance',	"hueh",	'https://twitter.com/HighPoweredArt',	"1", "2"],
		['DiskWraith',	'discwraith',	'Charter',	"I've only played Sonic Heroes",	'https://twitter.com/DiscWraith',	"1", "3"],
